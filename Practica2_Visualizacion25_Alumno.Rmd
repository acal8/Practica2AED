...
grafico2 <- ggplot(DatosEjer4, aes(x = Fecha, y = Ventas, color = Fabricante)) + geom_line()
grafico2

grafico3 <- ggplot(DatosEjer4, aes(x = Fecha, y = Ventas, color = Fabricante)) + geom_line(aes(linetype = Fabricante))
grafico3
